...
**Пример использования в приложении:** разный тип управления в игре и соответственно разные подсказки вида: 
Для передвижения и стрельбы используйте:
   - (nokeys) Джостик на экране и кнопку выстрела на экране
